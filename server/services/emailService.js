...
export const sendVerificationEmail = async (email, otp) => {
  try {
    const appName = process.env.EMAIL_FROM_NAME || "Your App Name"; // fallback
    const mailOptions = {
      from: `"${appName}" <${process.env.EMAIL_USERNAME}>`, // Customize sender name
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <a href="${process.env.FRONTEND_URL}/verify/${email}?otp=${otp}" 
...
export const sendForgotPassEmail = async (email, subject, customContent) => {
  try {
    const appName = process.env.EMAIL_FROM_NAME;
    const mailOptions = {
      from: `"${appName}"  <${process.env.EMAIL_USERNAME}>`, // Customize sender name
      to: email, // Recipient address
